...
namespace Payfi\Payments\Block\Adminhtml\System\Config\Fieldset;

/**
 * Fieldset renderer for Payfi payment
 */
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
  ...
  protected function _getFrontendClass($element)
  {
   ...
   /**
   * Return header title part of html for Payfi payments
   *
   * @param \Magento\Framework\Data\Form\Element\AbstractElement $element
   * @return string
  ...
  protected function _getHeaderTitleHtml($element)
  {
    ...
    $heading_style = "";
    $html .= '<div class="button-container admin__collapsible-block payfi-configure">'.
  ...
  /**
   * Return header comment part of html for Payfi payments
   *
   * @param \Magento\Framework\Data\Form\Element\AbstractElement $element
   * @return string
